...
function fetchData(city) {
  ...
  const urlCordinate = `https://api.openweathermap.org/geo/1.0/direct?q=${city}&limit=5&appid=${myAPIKey}&units=imperial`;
    ...
    .then(function (data) {
      ...
      fetch(url)
        ...
        .then(function (data) {
          ...
          secondDiv.setAttribute("class", "col-3 ms-5 lead fs-4 ");
